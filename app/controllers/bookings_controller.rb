class BookingsController < ApplicationController
    ...
    def update
        if (params[:notif])
            ...
            redirect_to user_notifications_path(@notification.receiver), notice: "You have approved #{@notification.sender.full_name}'s' request to book facility ##{@booking.facility_id}"     
